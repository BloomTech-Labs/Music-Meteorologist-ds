...
def create_app():
  ...
  ### Data engnering/ should be model.py ###
  df = pd.read_csv('SOUNDDRIP/data/SpotifyAudioFeaturesApril2019.csv')
  df_other = pd.read_csv('SOUNDDRIP/data/SpotifyAudioFeaturesNov2018.csv')
